...
# moving (~0.12-0.15). 0.10 tripped on ambient noise; 0.13 sits just under
# walking with more margin over empty. Override per-site with RUVIEW_PRESENCE_FLOOR.
Environment=RUVIEW_PRESENCE_FLOOR=0.13
