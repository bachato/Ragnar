...
| **Beacon flood** | A storm of fake APs (`mdk4` beacon mode) — dozens of bogus SSIDs to drown the air or bait clients. | Many distinct beaconed **SSIDs** (≥ 30) or **BSSIDs** (≥ 50) inside one short capture. |
